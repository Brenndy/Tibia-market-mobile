...
export const en: Record<TranslationKey, string> = {
  ...
  buy_alert_desc_below: 'Notify when buy price drops',
  buy_alert_desc_above: 'Notify when buy price rises',
  sell_alert_desc_below: 'Notify when sell price drops',
  sell_alert_desc_above: 'Notify when sell price rises',
  below_value: 'below threshold',
  above_value: 'above threshold',
  alert_direction_below: 'Drops ↓',
  alert_direction_above: 'Rises ↑',
  watch: 'Watch',
  buy_prefix: 'Buy:',
  sell_prefix: 'Sell:',
